...
gcc -o build/load_cell_calibrate.e -pthread src/load_cell_calibration.c src/numerical_basics.c src/method_of_least_squares.c src/ads1115.c -lpigpio -lrt -lm
